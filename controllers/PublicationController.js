...
const getAllPublications = async (req, res) => {
    try {
        ...
        FROM publication
        INNER JOIN instructeur ON publication.id_instructeur = instructeur.id    WHERE publication.status = 0
        `);
...
module.exports = {
    ...
    getPublicationById ,
    acceptPublication ,
    rejectPublication ,getPublicationsByInstructorId , updatePublicationInstructeur , createPublicationParticipant
};
